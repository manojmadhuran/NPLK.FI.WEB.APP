...
{
    public class CustomerRegistrationRequestDataEval
    {
        // ----------------------------------------- View Model For new Evaluation History update ---------- UpdateCode - FIU02
        ...
        public List<evaluationModel> EvaluationList { get; set;}
    }
}